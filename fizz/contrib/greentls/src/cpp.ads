...
is
   ...
   type Server_Name_Record_Array is array (Natural range <>) of Server_Name_Record;

   type Server_Name_List_Record is
      record
         Count          : Uint8_T;
         Server_Names : Server_Name_Record_Array (1 .. 8);
      end record
     with
       Convention => C;
